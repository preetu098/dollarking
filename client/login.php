...
<body>
    ...
    <div id="main-wrapper" class=" oxyy-login-register " style="background: #fc4a1a;background: -webkit-linear-gradient(to right, #f7b733, #fc4a1a);background: linear-gradient(to right, #f7b733, #fc4a1a); ">
        <div class="container">
            <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 col-lg-10 mx-auto">
                                ...
                                <h3 class="text-white text-center mb-1" style="margin-top: -110px!important;">Dollar King</h3>
                                <form id="loginForm" class="form-dark" action="validate_login.php" method="POST">
                                    ...
                                    <div class="d-grid my-4">
                                        ...
                                        style="background: #fc4a1a;background: -webkit-linear-gradient(to right, #f7b733, #fc4a1a);background: linear-gradient(to right, #f7b733, #fc4a1a);color:white ">SUBMIT</button>
